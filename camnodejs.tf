#####################################################################
##
##      Created 9/14/18 by admin. For Cloud ibm-public
##
#####################################################################
...
variable "cpus" {
  description = "Number of vCPU in the virtual guest"
}

variable "memory" {
  description = "Size of the memory in the virtual guest in MB"
}
...
##############################################################
# Create Virtual Machine and install Node.js
##############################################################
